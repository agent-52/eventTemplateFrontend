...
const Header = () =>{
    ...
    return(
        <header className="lightF fs1 noLineBreak bgLd">
            <div>
                <div className="flex alignC gap0">
                    <div className="logoContainer"><img src="/images/logo13.png" alt="" className="logoImg"/></div>
                    <div className="capital mediumF fs1_5">I DO!</div>
                </div>
            </div>
