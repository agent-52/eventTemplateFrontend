    ...
    return(
        <footer>
            <div className="pdb3 flexC justifyC alignC gap1">
                ...
                <h5 className="fs1 regularF">@idowao</h5>
            </div>
            ...
            <div className="flex justifySe lightF pdb6 mgT2 bT1W">
                ...
                <div className="mxW30 flexC gap00">
                    ...
                    <p className="mxW30"> WINDSOR FOUR SEASONS, Bannerghatta Rd, Classic Orchards Layout, Kalena Agrahara, Bengaluru, Karnataka 560076 </p>
                    <div>
